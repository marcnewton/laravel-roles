@props(['formTrigger', 'modalClass', 'actionBtnIcon'])
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-outline pull-left float-left" type="button" data-dismiss="modal" >
                    ...
                    {!! trans('laravel-roles::admin.modals.btnCancel') !!}
                </button>
                <button class="btn btn-{{ $modalClass }} pull-right" id="confirm" type="button" >
                    <i class="fa {{  $actionBtnIcon  }} fa-fw" aria-hidden="true"></i>
                    {{ trans('laravel-roles::admin.modals.btnConfirm') }}
                </button>
            </div>
        </div>
    </div>
